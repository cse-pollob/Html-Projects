    ...
    if(isset($_POST['title']))
    {
        ...
        if($title=="")
        {
           $message="title not be empty";
            ...
            mysqli_query($mysql,"INSERT INTO todo (title,remarks) VALUES ('$title', '$remarks')");
...
<body>
    ...
    <div class="row justify-content-center">
        ...
        <form action="" method="POST">
                ...
                <input type="text" class="form-control" id="exampleInputPassword1" name="remarks" placeholder="Remarks">
